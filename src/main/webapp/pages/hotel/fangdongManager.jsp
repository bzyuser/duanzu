			    ...
			    <div class="layui-tab-item layui-show">
							...
							<div class="mima">
								<div class="box3">
									<div class="left">
										...
										<div class="text"><p style="text-align: center;">2018年5月20日发布</p><p style="text-align: center;">房间编号： 323763</p></div>
									</div>
									<div class="middle">
				    ...
				    <div class="layui-tab-item">
				    	<div class="fangjianInfo">
							...
							<div class="typetable">
								<div class="box1">
								    <div class="text2"><p style="font-size: 20px;">真实姓名：</p></div>
								    <div class="shurukuang">
								    	<input type="text" class="form-control" placeholder="请输入户主真实姓名" id="name" />
								    </div>
							    </div>
							    <div class="box1">
								...
								<div class="box1">
								    <div class="text2"><p style="font-size: 20px;">年龄：</p></div>
								    <div class="shurukuang">
								    	<input type="text" class="form-control" placeholder="请输入户主年龄" id="name" />
								    </div>
							    </div>
								<div class="box1">
								    <div class="text2"><p style="font-size: 18px;">民族：</p></div>
								    <div class="houseType">
								    	<select class="type00">
							    ...
							    <div class="box1">
								    <div class="text2"><p style="font-size: 18px;">证件类型：</p></div>
								    <div class="houseType">
								    	<select class="type00">
							    ...
							    <div class="box1">
								    ...
								    <div class="shurukuang">
								    	<input type="text" class="form-control" placeholder="请输入户主证件号码"/>
								    </div>
							    </div>
							    <div class="box1">
								    <div class="text2"><p style="font-size: 20px;">手机号码：</p></div>
								    <div class="shurukuang">
								    	<input type="text" class="form-control" placeholder="请输入户主手机号码" maxlength="11"/>
								    </div>
							    </div>
							    <div class="box1">
								    <div class="text2"><p style="font-size: 20px;">职业：</p></div>
								    <div class="shurukuang">
								    	<input type="text" class="form-control" placeholder="请输入户主职业"/>
								    </div>
							    </div>
							    <div class="box1">
							    	<div class="text2"><p style="font-size: 20px;">简介：</p></div>
							    	<div class="beizhu">
							      		<textarea placeholder="户主简介" class="layui-textarea" name="desc"style="width: 600px;"></textarea>
							    	</div>
							  	</div>
							  	<div class="box1">
							    	<div class="text2"><p style="font-size: 20px;">备注：</p></div>
							    	<div class="beizhu">
							      		<textarea class="layui-textarea" name="desc" style="width: 600px;"></textarea>
							    	</div>
					  			</div>
						    </div>
					    </div>
